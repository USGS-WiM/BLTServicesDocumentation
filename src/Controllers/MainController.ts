...
module BLT.Controllers {
    ...
    class MainController implements IMainController {
        ...
        //Constructor
        //-+-+-+-+-+-+-+-+-+-+-+-
        static $inject = ['$scope', '$filter', 'BLT.Services.ResourceService', 'leafletBoundsHelpers', 'leafletData'];
    ...
    angular.module('BLT.Controllers')
        .controller('BLT.Controllers.MainController', MainController)
}//end module